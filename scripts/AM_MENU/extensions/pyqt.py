...
from AM_MENU.extensions.Qt import QtSvg
from AM_MENU.core.python_utils import  PY2
...
def _qt_import(binding, shi=False, cui=False):
    ...
    if binding == "PySide2":
        ...
        if mc.about(apiVersion = True) < 20220000 :
...
if mc.about(apiVersion = True) < 20220000:
    ...
    def ui2py(filePath=None, *args):
        ...
        mc.displayInfo(info + compiledFilePath)
